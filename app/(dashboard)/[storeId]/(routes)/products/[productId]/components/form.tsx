...
export const ProductsForm: React.FC<ProductsFormProps> = ({
  ...
  const description = initialData ? "Edit your existing Product" : "Add a New Product";
  const toastMessage = initialData ? "Product Updated." : "New Product Created.";
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <FormField
              ...
              name="isFeatured"
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md bborder p-4 ">
                  <FormControl>
                    <Checkbox 
                      checked={field.value}
